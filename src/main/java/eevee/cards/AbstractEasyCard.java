...
import eevee.Eevee;
import eevee.util.CardArtRoller;

import static eevee.EeveeMod.makeImagePath;
import static eevee.EeveeMod.modID;
import static eevee.util.Wiz.atb;
import static eevee.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, Eevee.Enums.EEVEE_COLOR);
    }
